    ...
    return (
        <div id='About' className='container-fluid'>
            ...
            <h3 className='d-flex m-2 justify-content-center'>
                ...
                </p><p>We make nothing and this was done by the work of only one person....until now that is.
                </p><p>Goodbye and byebye world. I will be back ith some more spicy news
                </p>
                </div>
            </h3>
